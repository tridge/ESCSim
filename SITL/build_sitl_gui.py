...
does not cross compile.
  ...
  python3 SITL/build_sitl_gui.py [--onedir] [--sitl PATH]
'''
...
HERE = os.path.dirname(os.path.abspath(__file__))       # ESCSim/SITL

sys.path.insert(0, HERE)
import am32_paths
import sitl_params

# PyInstaller output goes under the ESCSim tree; the SITL binary comes
# from the firmware checkout
ROOT = am32_paths.ESCSIM_ROOT
...
def _find_sitl(given):
    ...
    # the cross-built native Windows exe, staged by CI
