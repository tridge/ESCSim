...
The later captures used an experimental bias-compensation build with
debug1 v2 that is not part of this tree. Idle reads 0.00-0.02 A and
0.24 A at 0.5 throttle in those captures. Gain is still the stock
30 mV/A, not yet checked against the bench supply. rpm behaviour was
unchanged by the reflash (4372 /
...
Fitted against the captures above (procedure per SITL/scripts/CALIBRATION.md,
...
`python3 SITL/scripts/esc_plot.py SITL/data/VIMDRONES_L431/square2.jsonl SITL/data/VIMDRONES_L431/sitl_square_v2.jsonl`
