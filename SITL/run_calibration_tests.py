...
reference values in SITL/data/<TARGET>/expected.json.
...
# a stable cwd for the measurement tools; every path they are given is
# absolute
REPO = am32_paths.ESCSIM_ROOT
SCRIPTS = am32_paths.scripts_dir()
...
def main():
    ...
    sitl_bin = os.path.abspath(am32_paths.sitl_binary(ARGS.sitl))
