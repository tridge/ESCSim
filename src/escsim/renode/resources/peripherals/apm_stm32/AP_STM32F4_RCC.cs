...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    ...
    public class AP_STM32F4_RCC : IDoubleWordPeripheral, IKnownSize
    {
            ...
            uint lseFrequency = DefaultLseFrequency, bool isF7 = false)
        {
            ...
            // Cortex-M handles AIRCR internally and resets the machine without
            // passing the cause to RCC. Capture SYSRESETREQ so firmware sees
            // SFTRSTF, as it does on STM32 silicon.
        ...
        public void Reset()
        {
            ...
            registers[CSR] = pendingSoftwareReset
                ? SFTRSTF
                : PORRSTF | PINRSTF | BORRSTF;
        ...
        private const uint SFTRSTF = 1u << 28;
